...
class ScoreStartWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return _ScoreStartWidgetState();
  }
}

class _ScoreStartWidgetState extends State<ScoreStartWidget> {
      ...
      child: Column(
        children: <Widget>[
          Row(
            children: <Widget>[
              Expanded(
                child: Text('评分',style: TextStyle(fontSize: 12.0,color: Colors.white)),
              ),
              Icon(
                Icons.chevron_right,
